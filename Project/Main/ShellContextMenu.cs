...
namespace ShenmueHDTools.Main
{
    public class ShellContextMenu : NativeWindow
    {
        ...
        private void ShowContextMenu(Point pointScreen)
        {
            ...
            try
            {
                ...
                mii.fMask = MIIM.ID | MIIM.TYPE | MIIM.STATE | MIIM.SUBMENU;
                mii.fType = 0;
                mii.dwTypeData = "Open in explorer";
    ...
    internal static class ShellHelper
    {
        ...
        {
            if (((UInt64)ptr & 0x80000000) == 0x80000000)
                return (uint)((UInt64)ptr >> 16);
            else
                return (uint)((UInt64)ptr >> 16) & 0xffff;
        }

        public static uint LoWord(IntPtr ptr)
        {
            return (uint)((UInt64)ptr & 0xffff);
        }
