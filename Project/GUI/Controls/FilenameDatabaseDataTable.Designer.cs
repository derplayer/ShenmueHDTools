namespace ShenmueHDTools.GUI.Controls
{
    partial class FilenameDatabaseDataTable
    {
        ...
        {
            this.dataGridView_DB = new ShenmueHDTools.GUI.Controls.DataGridViewEx();
            ...
            this.dataGridView_DB.ColumnHeaderMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(this.dataGridView_DB_ColumnHeaderMouseClick);
            // 
            // ColumnHash1
            // 
        ...
        private ShenmueHDTools.GUI.Controls.DataGridViewEx dataGridView_DB;
